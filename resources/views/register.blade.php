    ...
    <x-slot name="header">
        ...
        <form method="POST" action="{{ route('register') }}" id="regForm">
            ...
            <div>
                ...
                <x-input id="lastname" class="block mt-1 w-1/6" type="text" name="lastname" :value="old('lastname')" autofocus />
            </div>
            ...
            <div>
                ...
                <x-input id="address2" class="block mt-1 w-1/3" type="text" name="address2" :value="old('address2')" autofocus />
            </div>
            ...
            <div>
                ...
                <div class="invalid-feedback zipcode">
                    Please provide a valid zip that's either 5 or 9 digits in length
                </div>
            </div>
            ...
            <div>
                ...
                <div class="invalid-feedback country">
                    Please chose a US Country
                </div>
            </div>
